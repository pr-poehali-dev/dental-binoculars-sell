          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                {[
                  "Дилерские цены с фиксированной скидкой до 35% от РРЦ",
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Активная клиентская база стоматологических клиник и докторов в регионе",
                  "Наличие продавцов/менеджеров для работы с клиентами",
                  "Готовность к обучению по продукту (онлайн, 1 - 1,5 часа)",
