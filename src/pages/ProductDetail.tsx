...
const productsData: ProductDetails[] = [
  ...
  {
    id: 5,
    name: 'Универсальный беспроводной осветитель Pro Max',
    description: 'Универсальный беспроводной осветитель Pro Max обеспечивает непрерывную работу без необходимости подключения к кабелю. Высокое качество света, имеются два уровня яркости, переключаемые сенсорным нажатием',
    price: 59000,
    oldPrice: 65000,
    images: [
    ...
    fullDescription: 'Универсальный беспроводной осветитель Pro Max обеспечивает непрерывную работу без необходимости подключения к кабелю. Высокое качество света, имеются два уровня яркости, переключаемые сенсорным нажатием. Идеальное решение для профессионалов, работающих с бинокулярными лупами. Легкий вес и эргономичная конструкция обеспечивают комфорт при длительной работе.',
    specifications: [
