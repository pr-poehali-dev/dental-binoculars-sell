...
const productsData: ProductDetails[] = [
  {
    ...
    description: 'Апохроматические линзы из оптического стекла HOYA (Япония). Асинхронная настройка межзрачкового расстояния',
    price: 71000,
    oldPrice: 87000,
    images: [
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/d1dd7531-125e-42fe-9942-d42967edefac.jpg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/37e13070-6eee-4c1c-b9e9-47c4d9719240.jpg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/53856a48-c782-40bc-85d6-911423dbf732.jpg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/4b44c155-57ba-4585-a3b2-acec5292eafc.jpg'
    ],
    magnification: '5.0х',
    weight: 'Зависит от конфигурации',
    fullDescription: 'Бинокулярные лупы Pro 5.0х — профессиональное решение с апохроматическими линзами из оптического стекла HOYA (Япония). Многослойное покрытие с антибликовым эффектом и защитой от запотевания и царапин. Асинхронная настройка межзрачкового расстояния. Высокая прочность и легкость за счет материала аэрокосмического класса. Высокое разрешение, чистое и четкое поле обзора без размытия и виньетирования. Возможность крепления осветительного прибора. Рекомендуем использовать в паре с «головной осветитель Pro» или "Универсальный Осветитель Беспроводной" на оригинальном креплении (Не клипса)',
    specifications: [
      { label: 'Увеличение', value: '5.0х' },
      { label: 'Рабочее расстояние', value: '400, 450 мм' },
      ...
      { label: 'Материал оправы', value: 'Металл' },
  ...
  },
  {
    ...
    description: 'Апохроматические линзы из немецкого оптического стекла Schott. Карбоновая оправа из углеродного волокна',
    price: 57000,
    oldPrice: 70000,
    images: [
      ...
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/ebf009c4-aed4-4fb6-949b-4dcc0f21bbc6.jpg'
    ],
    magnification: '3.5х',
    weight: 'Зависит от конфигурации',
    fullDescription: 'Бинокулярные лупы Carbon 3.5x — профессиональное решение с апохроматическими линзами из немецкого оптического стекла Schott. Многослойное покрытие с антибликовым эффектом и защитой от запотевания и царапин. Асинхронная настройка межзрачкового расстояния. Высокое разрешение, чистое и четкое поле обзора без размытия и виньетирования. Карбоновая оправа из углеродного волокна сочетает высокую прочность и жёсткость с очень малой массой, с возможностью установки индивидуальных диоптрий. Возможность крепления осветительного прибора. Рекомендуем использовать в паре с «Беспроводной осветитель Pro Max»',
    specifications: [
      { label: 'Увеличение', value: '3.5х' },
      { label: 'Рабочее расстояние', value: '450 мм' },
      { label: 'Поле обзора', value: '120 мм' },
      { label: 'Глубина обзора', value: '200 мм' },
      { label: 'Оптика', value: 'Апохроматические линзы Schott' },
      { label: 'Покрытие', value: 'Многослойное антибликовое с защитой от запотевания' },
      { label: 'Материал оправы', value: 'Углеродное волокно (Carbon)' },
      { label: 'Настройка', value: 'Асинхронная регулировка межзрачкового расстояния' }
    ],
    package: [
      'Бинокулярные лупы с адаптером для компенсирования диоптрий',
      'Салфетка для чистки',
      'Ключ/Отвертка',
      'Шнурок',
      'Инструкции',
  ...
  },
  {
    ...
    oldPrice: 140000,
    images: [
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/d42af292-859d-4434-a32d-0b309c023fdd.jpg',
    ...
    weight: 'Зависит от конфигурации',
    fullDescription: 'Бинокулярные лупы Carbon Ergo — профессиональное решение с апохроматическими линзами из немецкого оптического стекла Schott. Многослойное покрытие с антибликовым эффектом и защитой от запотевания и царапин. Конструкция бинокуляров, расположенная под углом, что позволяет держать голову прямо, благодаря чему снижается нагрузка на спину и шею. Асинхронная настройка межзрачкового расстояния. Высокое разрешение, чистое и четкое поле обзора без размытия и виньетирования. Карбоновая оправа из углеродного волокна сочетает высокую прочность и жёсткость с очень малой массой, с возможностью установки индивидуальных диоптрий. Возможность крепления осветительного прибора. Рекомендуем использовать в паре с «Беспроводной осветитель Pro Max»',
    specifications: [
      ...
      { label: 'Материал оправы', value: 'Углеродное волокно (Carbon)' },
      { label: 'Настройка', value: 'Асинхронная регулировка межзрачкового расстояния' },
      { label: 'Эргономика', value: 'Угловая конструкция для прямой посадки' }
    ],
    package: [
      'Бинокулярные лупы с адаптером для компенсирования диоптрий',
      'Салфетка для чистки',
  ...
  },
  {
    ...
    fullDescription: 'Беспроводной осветитель Pro Max обеспечивает непрерывную работу без необходимости подключения к кабелю. Высокое качество света, имеются два уровня яркости, переключаемые сенсорным нажатием. Идеальное решение для профессионалов, работающих с бинокулярными лупами. Легкий вес и эргономичная конструкция обеспечивают комфорт при длительной работе. В комплекте имеется клипса/прищепка для универсального крепления к любым бинокулярам.',
    specifications: [
    ...
    package: [
      ...
      'Желтый фильтр 1 шт',
      'Ключ/Отвертка 1 шт',
      'Клипса для универсального крепления к любым бинокулярам 1 шт',
  ...
  },
  {
    ...
    oldPrice: 160000,
    images: [
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/fca5e53c-2307-4b76-bf1b-6ca638024c0b.jpeg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/df669c6d-77e0-4f86-a642-433ca1cd77b1.jpeg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/1a3e4a51-7b6b-457e-ba78-b2ea9bd31819.jpeg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/8e5d3415-40b0-4b12-b50e-1bd9f0f86765.jpeg',
      'https://cdn.poehali.dev/projects/37487b42-26a7-4ea4-bd44-c9a83bc78370/bucket/528be5e2-cb24-4209-9a8b-fe3b01a6fc74.jpeg'
    ],
    magnification: '3.0х / 4.0х / 5.0х / 6.0х',
    weight: 'Зависит от конфигурации',
    fullDescription: 'Бинокулярные лупы Titanium Ergo Pro Max — профессиональное решение с апохроматическими линзами из немецкого оптического стекла Schott. Многослойное покрытие с антибликовым эффектом и защитой от запотевания и царапин. Конструкция бинокуляров, расположенная под углом, что позволяет держать голову прямо, благодаря чему снижается нагрузка на спину и шею. Асинхронная настройка межзрачкового расстояния. Высокое разрешение, чистое и четкое поле обзора без размытия и виньетирования. Максимально легкая, прочная классическая оправа из титанового сплава, с возможностью установки индивидуальных диоптрий. Возможность крепления осветительного прибора. Рекомендуем использовать в паре с «Беспроводной осветитель Pro Max»',
    specifications: [
      { label: 'Увеличение', value: '3.0х, 4.0х, 5.0х, 6.0х' },
      { label: 'Рабочее расстояние', value: '450-550 мм' },
      { label: 'Поле обзора', value: '50-105 мм' },
      ...
      { label: 'Оптика', value: 'Апохроматические линзы Schott' },
      { label: 'Покрытие', value: 'Многослойное антибликовое с защитой от запотевания' },
      { label: 'Материал оправы', value: 'Титановый сплав' },
      { label: 'Настройка', value: 'Асинхронная регулировка межзрачкового расстояния' },
      { label: 'Эргономика', value: 'Угловая конструкция для прямой посадки' }
    ],
    package: [
